...
jQuery(window).on("load", function() {
  ...
  var config = {
    ...
    '#selectv19'  : {allowClear: true},
    '#teaching-classes'  : {allowClear: true},
    '#selectv10'  : {allowClear: true},
    '#schooling'  : {allowClear: true},
    '#selectv11'  : {allowClear: true},
    '#qualification'  : {allowClear: true},
  ...
  collapseMenu();
   ...
   if( lo_typethree !== null){
     var typed = new Typed(".type", {
       strings:["fueling growth", "building confidence", "encouraging curiosity"],
       typeSpeed: 100,
       backSpeed:100,
       loop: true,
       showCursor: false,
...
/* PRELOADER*/
jQuery(window).on("load",function () { 
  jQuery(".tu-preloader").delay(800).fadeOut();
  jQuery(".tu-preloader_holder").delay(800).fadeOut("slow");
})
